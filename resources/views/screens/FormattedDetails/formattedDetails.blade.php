            ...
            <form id="applicationForm" class="needs-validation" novalidate>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-floating form-floating-outline mb-4">
                            <input type="text" class="form-control" id="jobApplied" placeholder="Job Applied"
                                required />
                        ...
                        <div class="mb-4">
                            <div class="input-group input-group-merge">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control" id="keySkills" placeholder="Key Skills"
                                        required />
                        ...
                        <div class="form-floating form-floating-outline mb-4">
                            <input type="number" class="form-control" id="workExperience" placeholder="Work Experience"
                                required />
                    ...
                    <div class="col-md-6">
                        <div class="form-floating form-floating-outline mb-4">
                            <input type="number" class="form-control" id="currentSalary" placeholder="Current Salary"
                                required />
                        ...
                        <div class="form-floating form-floating-outline mb-4">
                            <input type="text" class="form-control" id="highestQualification"
