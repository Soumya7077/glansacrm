                ...
                interviews.forEach(interview => {
                    ...
                    const row = `
                                            <tr class="text-center small align-middle">
                                                ...
                                                <td>
                                                    <div class="">
                                                        <a href=/schedule?interview=${data} class="btn btn-primary btn-sm p-2 mb-2" data-id="${interview.id}" data-status="${interview.sid}" style="width: 120px;">Re-Schedule</a>
                                                        <a href=/offerletter?interview=${data} class="btn btn-success btn-sm p-2" data-id="${interview.id}" data-status="${interview.sid}" style="width: 120px;">Send Offerletter</a>
                                                    </div>
                                                    </td>
                                                </tr>`;
                    tbody.append(row);
