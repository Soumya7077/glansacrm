...
@section('content')
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasBackdrop" aria-labelledby="offcanvasBackdropLabel">
      ...
      <form id="departmentForm" novalidate>
        ...
        <div class="col-md-12">
          ...
          <input type="text" class="form-control" id="deptName" name="name" placeholder="Name" required />
          <label for="deptName">Name <span style="color: red;">*</span></label>
  ...
  @push('scripts')
    ...
    function fetchDepartments() {
      ...
      let tbody = $("#tbody");
      tbody.html('<tr><td colspan="4" class="text-primary">Loading...</td></tr>');
      $.ajax({
