                ...
                <tbody id="empList">
                    ...
                    <td class="text-center">
                        <div class="d-flex justify-content-center">
                            ...
                            <button class="btn btn-sm btn-danger delete-btn ms-2" type="button" data-bs-toggle="offcanvas"
                                data-bs-target="#offcanvasBackdrop" aria-controls="offcanvasBackdrop">Delete</button>
                        </div>
                    </td>
                </tbody>
            </table>
